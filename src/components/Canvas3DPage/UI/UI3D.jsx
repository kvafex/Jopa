...
import {
    Point, Light, Cube, Ring, Sphere, BottleKleine,
...
const UI3D = (props) => {
    ...
    const changeLumen = props.changeLumen;
    const changeXLight = props.changeXLight;
    const changeYLight = props.changeYLight;
    const changeZLight = props.changeZLight;
    const math3D = props.math3D;
    const show = props.show;

    const [showCanvasParam, setShowCanvasParam] = useState(false);
    const [showLightParam, setShowLightParam] = useState(false);
    const [showAddChangeList, setShowAddChangeList] = useState(false);
                        ...
                        <div className="flex_c">
                            ...
                            <div className="flex_c">Добавить:
                                <select defaultValue={'Фигуры'} onClick={(event) => addFigure(event)} className="output mar_b">
                                    ...
                                    <option disabled value="TwoHyperbole">TWO HYPERBOLE</option>
                                    <option disabled value="Ellipsoid">ELLIPSOID</option>
